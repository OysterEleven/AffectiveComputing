...
%	    T             column vector giving the index of the first 
%			  sample in each frame
%           DC(nf)        optional dc component will be subtracted 
%			  from the signal
%           FADE          AR coefficients will be linearly interpolated 
% 			  for FADE samples either side offrame boundaries
%
